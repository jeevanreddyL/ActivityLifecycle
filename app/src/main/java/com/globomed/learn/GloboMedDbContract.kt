...
object GloboMedDbContract {
    ...
    object EmployeeEntry : BaseColumns {
        ...
        const val SQL_CREATE_ENTRIES: String =
            "CREATE TABLE ${EmployeeEntry.TABLE_NAME} (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + "$COLUMN_NAME TEXT NOT NULL, " + "$COLUMN_DOB INTEGER NOT NULL, " + "$COLUMN_DESIGNATION TEXT NOT NULL)"
